...
def comm_GH(args, adj, clients, debug=False, test_loader=None):
    '''
        ...
        #receive protos
            if req_aggregation[i]:
                ...
                if args.clustered_agg:
                    ...
                    received_protos = receive_protos(clients[i], adj_clients) #neighbors adj_clients
                    #clients[i].uploaded_protos = copy.deepcopy(received_protos)
                    clients[i].train_head(received_protos) 
