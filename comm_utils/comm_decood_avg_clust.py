...
def comm_decood_avg_clust(args, adj, clients, debug=False, test_loader=None):
    '''
    ...
    for e in range(args.num_rounds):
        ...
        #receive protos
            if req_aggregation[i]:
                ...
                #     new_models[i][key] = W * clients[i].model.head.state_dict()[key]
                ...
                #         new_models[i][key] += W * sc.model.head.state_dict()[key]


                #Body only
                # W = len(clients[i].train_loader.dataset)/N
                # for key in clients[i].model.base.state_dict().keys():              
                #     new_models[i][key] = W * clients[i].model.base.state_dict()[key]
                ...
                #         new_models[i][key] += W * sc.model.base.state_dict()[key]
                ...
                if args.clustered_agg:
                    ...
                    rec_protos = receive_protos(clients[i], id_neighbors) #neighbors adj_clients
