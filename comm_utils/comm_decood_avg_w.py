...
def comm_decood_avg_w(args, adj, clients, debug=False, test_loader=None):
    '''
    parameters:
    args: global args
    adj: gossip matrix
    ...
    For a client i, Aggregates(gossip) model parameters and prototypes from all clients
    based on the matrix adj. 
    '''
    ...
    for e in range(args.num_rounds):
        ...
        for m in clients:
            ...
            m.update() #update model and protos
        ...
        #receive protos
            if req_aggregation[i]:
                ...
                if args.clustered_agg:
                    ...
                    rec_protos = receive_protos(clients[i], adj_clients, adj)       #neighbors adj_clients
