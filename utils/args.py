...
def parse_args(args_list=None):
    ...
    parser.add_argument(
        ...
        help='the method to be used;'
             ...
             ' `pFedMe`, `AFL`, `FFL`, `FedEMCont` and `clustered`;',
        type=str
    )
    parser.add_argument(
        '--decentralized',
    ...
    parser.add_argument('--num_clients', default=5, type=int, help='Total number of clients')
    ...
    parser.add_argument('--dataset', default='digit', help='Dataset name')
