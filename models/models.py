...
class CNNMnist2(nn.Module):
    def __init__(self, in_features=1, num_classes=10, dim=1024):
        ...
        self.conv2_drop = nn.Dropout2d()
        self.fc1 = nn.Linear(320, 50)                   #feature dim 50
        self.fc2 = nn.Linear(50, args.num_classes)
...
class CNNFashion_Mnist(nn.Module):
    def __init__(self, args):
        ...
        self.layer2 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.MaxPool2d(2))
        self.fc = nn.Linear(7*7*32, 10)      ###featre dimension 7*7*32
...
class CifarNet(nn.Module):
    def __init__(self, num_classes=10):
        super(CifarNet, self).__init__()
        self.conv1 = nn.Conv2d(3, 64, 5) #input channel 3
        self.pool = nn.MaxPool2d(2, 2)
        self.conv2 = nn.Conv2d(64, 64, 5)
        self.fc1 = nn.Linear(64 * 5 * 5, 384)
        self.fc2 = nn.Linear(384, 128)      #dimension of embeding 84
